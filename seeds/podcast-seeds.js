...
const podcastData = [
  ...
  },
  {
    ...
    description:'Breaking Points is a fearless anti-establishment multi-week Youtube and Podcast which holds the powerful to account hosted by Krystal Ball and Saagar Enjeti',
    genre_id:1
  },
  {
    title: 'Your Moms House',
    creator: 'Christina Pazsitzky & Tom Segura',
    description: 'Christina Pazsitzky and Tom Segura are comedians who are also married. They are the Mommies and they welcome you to join them. Dental updates! Dudes! Stories! Wiping!',
    genre_id: 3
  },
  {
    title: 'Flagrant 2',
    creator: 'Andrew Schulz and Akaash Singh',
    description: 'Flagrant 2 is a comedy podcast that delivers unfiltered, unapologetic, and unruly hot takes directly to your dome piece. In an era dictated by political correctness, hosts Andrew Schulz and Akaash Singh, along with AlexxMedia and Mark Gagnon, could care less about sensitivities. If it’s funny and flagrant it flies. If you are sensitive this podcast is not for you. But if you miss the days of comedians actually being funny instead of preaching to a choir then welcome to The Flagrancy.',
    genre_id: 3
  },
  {
    title: 'Twin Flames',
    creator: 'Stephanie Beatriz',
    description:'We all want love, that happily-ever-after feeling of finding your soulmate. What if someone not only claimed they could help you find that perfect partner, they guaranteed it? Jeff and Shaleia, a young couple famous on YouTube, teach about Twin Flames a deep, romantic connection with your perfect partner in their videos. It’s divine love, you’re designed for no one else, and they’re designed for no one else. But the path to finding your Twin Flame isn’t so simple. Some followers claim they were encouraged to cut ties with friends and family that are holding them back, and to claim their Twin Flame by any means necessary. From Wondery, Twin Flames is a podcast about what happens when the quest for love turns into a dangerous obsession.',
    genre_id: 5 
  },
  {
    title: 'Escaping NXIVM',
    creator: 'CBC Podcasts',
    description: 'NXIVM (pronounced "Nexium") calls itself a humanitarian community. Experts call it a cult. Uncover: Escaping NXIVM is an investigative podcast series about the group, its leader Keith Raniere and one womans journey to get out. From CBC Podcasts and CBC News.',
    genre_id: 2
  },
  {
  ...
  },
  {
    ...
    description:'Charlamagne Tha God and Andrew Schulz are The Brilliant Idiots. Join them each week as they explore the issues of the day in a style thats often idiotic, sometimes brilliant and always hysterical.',
    genre_id: 3
  },
  {
